...
- CODE_10259 | count=1 | risk=accepted smoke-only risk
...
- CODE_10762 | count=4 | risk=accepted smoke-only risk
...
- CODE_10858 | count=5 | risk=accepted smoke-only risk
...
- CODE_113027 | count=2 | risk=accepted smoke-only risk
...
- CODE_113028 | count=1 | risk=accepted smoke-only risk
...
- CODE_13009 | count=1 | risk=needs review before timing gate
  sample: Warning (13009): TRI or OPNDRN buffers permanently enabled
- CODE_13010 | count=21 | risk=needs review before timing gate
...
- CODE_13024 | count=1 | risk=needs review before timing gate
  sample: Warning (13024): Output pins are stuck at VCC or GND
- CODE_13032 | count=1 | risk=needs review before timing gate
  sample: Warning (13032): The following tri-state nodes are fed by constants
- CODE_13033 | count=5 | risk=needs review before timing gate
...
- CODE_13039 | count=1 | risk=needs review before timing gate
  sample: Warning (13039): The following bidirectional pins have no drivers
- CODE_13040 | count=1 | risk=needs review before timing gate
...
- CODE_13410 | count=64 | risk=needs review before timing gate
...
- CODE_14284 | count=2 | risk=safe / known inherited
  sample: Warning (14284): Synthesized away the following node(s):
- CODE_14285 | count=2 | risk=safe / known inherited
  sample:     Warning (14285): Synthesized away the following RAM node(s):
- CODE_14320 | count=13 | risk=safe / known inherited
...
- CODE_15610 | count=8 | risk=needs review before timing gate
...
- CODE_15714 | count=1 | risk=needs review before timing gate
  sample: Warning (15714): Some pins have incomplete I/O assignments. Refer to the I/O Assignment Warnings report for details
- CODE_16406 | count=1 | risk=needs review before timing gate
  sample: Warning (16406): 1 global input pin(s) will use non-dedicated clock routing
- CODE_16407 | count=1 | risk=needs review before timing gate
  sample:     Warning (16407): Source REFCLK I/O is not placed onto a dedicated REFCLK input pin for global clock driver bridge_spiclk~inputCLKENA0, placed at CLKCTRL_G8
- CODE_169064 | count=1 | risk=needs review before timing gate
...
- CODE_170136 | count=1 | risk=needs review before timing gate
...
- CODE_176251 | count=1 | risk=needs review before timing gate
  sample: Warning (176251): Ignoring some wildcard destinations of fast I/O register assignments
- CODE_19016 | count=1 | risk=needs review before timing gate
  sample: Warning (19016): Clock multiplexers are found and protected
- CODE_19017 | count=1 | risk=needs review before timing gate
...
- CODE_21074 | count=1 | risk=needs review before timing gate
  sample: Warning (21074): Design contains 8 input pin(s) that do not drive logic
- CODE_287013 | count=1 | risk=safe / known inherited
...
- map errors: 0
- fitter errors: 0
- review source: docs/OPENFPGA_GENESIS_FITTER_UNKNOWN_WARNING_REVIEW.md
