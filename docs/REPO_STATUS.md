...
- package schema valid: yes
- BIOS probe staged: yes

## Exact fit/timing/package state
...
- staged core path: build/pocket_sd_megacd_bios_probe/Cores/Gr33k.SegaCDBiosProbe
- staged platform path: build/pocket_sd_megacd_bios_probe/Platforms/genesis.json
