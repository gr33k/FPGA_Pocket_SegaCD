...
Generated: 2026-07-08T16:58:22Z
...
PASS: Status file exists: docs/OPENFPGA_GENESIS_ANALYSIS_ONLY_STATUS.md
PASS: Connectivity warning evidence file exists: docs/OPENFPGA_GENESIS_CONNECTIVITY_WARNINGS.txt
...
PASS: Check complete: docs/OPENFPGA_GENESIS_ANALYSIS_RUNNER_CHECK.md
